...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav side-nav">
			...
			<li>
				<a href="<?= base_url('admin/req');?>"><i class="fa fa-fw fa-dashboard"></i> Requests</a>
			</li>
			<li>
			...
			<li>
				<a href="javascript:;" data-toggle="collapse" data-target="#demo5"><i class="fa fa-fw fa-arrows-v"></i> Students <i class="fa fa-fw fa-caret-down"></i></a>
				<ul id="demo5" class="collapse">
					<li>
						<a class="tablinks fa  fa-file" href="<?= base_url('admin/add_student');?>"> Add New Student</a>
					</li>
					<li>
						<a class="tablinks fa  fa-file" href="<?= base_url('admin/list_students');?>"> List Students</a>
					</li>
				</ul>
