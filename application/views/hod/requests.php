    ...
    <table class="table table-striped table-hover table-bordered">
        ...
        <tr>
            ...
            <td style="display: flex">
                ...
                <form class="accept teacher-form" style="margin: 1%" action="<?php echo base_url('hod/resp_req/4');?>" method="POST" >
                    <fieldset>
                ...
                <form class="reject teacher-form" style="margin: 1%" action="<?php echo base_url('hod/resp_req/3');?>" method="POST" >
                    <fieldset>
                        <input type="hidden" name="id" value="<?php echo $data->id ?>"  >
                        <input type="hidden" name="des_data" value="<?php echo $data->description;?>"  >
