    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li class="active">
                    <a href="<?= base_url('hod');?>"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                </li>
                <li>
                    <a href="<?= base_url('hod/req');?>"><i class="fa fa-fw fa-dashboard"></i> Requests</a>
                </li>

                <li>
                    <a href="<?php echo base_url('hod/edit_pass');?>"><i class="fa fa-fw fa-edit"></i> Profile</a>
                </li>
                <li>
                    <a href="<?php echo base_url('Hod/logout');?>" class="fa fa-power-off"?> Logout</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
